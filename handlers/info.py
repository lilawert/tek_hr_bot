...
async def company(message: Message):
    ...
    if not (files['videos'] or files['photos'] or files['applications']):
...
async def schedule(message: Message):
    await message.answer(text=t('info.schedule'))

@router.message(Command('support'))
async def schedule(message: Message):
    await message.answer(text=t('info.support'))

@router.message(Command('im'))
async def schedule(message: Message):
    await message.answer(text=t('info.im'))